...
/**
 * Handles the `/socialspy` command, allowing players to toggle the Social Spy feature.
...
public class CommandSocialSpy implements CommandExecutor, TabCompleter {
    ...
    /**
     * Constructor for the CommandSocialSpy class.
     * Initializes the command executor and tab completer for the `/socialspy` command.
     */
    ...
    /**
     * Handles the execution of the `/socialspy` command.
     *
    ...
    /**
     * Provides tab completion suggestions for the `/socialspy` command.
     *
